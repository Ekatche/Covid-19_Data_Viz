...
df_md_gbd_2 = df_md_gbd_1.groupby(['Country_Region', 'observation_date']).sum().groupby(level=0)[['confirmed','deaths','recovered']].cumsum().sort_values(
